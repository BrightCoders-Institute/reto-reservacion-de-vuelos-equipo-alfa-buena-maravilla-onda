        ...
        <View style={LoadingModalStyles.modalContainer}>
          <View style={LoadingModalStyles.modalContent}>
            {completed ? (
              ...
              <>
                <ActivityIndicator size="large" color="#5974f5" animating={isSigningIn} style={LoadingModalStyles.activityIndicator} />
                <Text style={LoadingModalStyles.messageText}>{message}</Text>
              </>
            )}
            {signInCompleted && (
              <Ionicons name="checkmark" size={30} color="#5974f5" style={LoadingModalStyles.checkmarkIcon} />
            )}
          </View>
        </View>
      </Modal>
